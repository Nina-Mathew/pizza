...
// Created on:10/8/20
// This program finds the cost of pizza
game.splash("Pizza Order")
let Labour_cost = 0.75
let Rent = 1
let Diameter = game.askForNumber("Enter the diameter of the pizza.")
let material = 0.5
let Original_cost = material * Diameter
let Labour_Rent = Labour_cost + Rent
let HST = 1.13
